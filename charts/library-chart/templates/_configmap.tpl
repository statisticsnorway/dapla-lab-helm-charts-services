...
{{- define "library-chart.configMapNameOidc" -}}
{{- if .Values.oidc.enabled }}
{{- $name:= (printf "%s-configmapoidc" (include "library-chart.fullname" .) )  }}
{{- default $name .Values.oidc.configMapName }}
{{- else }}
{{- default "default" .Values.oidc.configMapName }}
{{- end }}
{{- end }}

{{/* Template to generate a ConfigMap for OIDC */}}
{{- define "library-chart.configMapOidc" -}}
